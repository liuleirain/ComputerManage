        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuickServiceCode = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "Name", "NormalizedName" },
                values: new object[] { "a18be9c0-aa65-4af8-bd17-00bd9344e575", "1", "SuperAdministrator", "SUPERADMINISTRATOR" });

            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "Discriminator", "Email", "EmailConfirmed", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { "a18be9c0-aa65-4af8-bd17-00bd9344e575", 0, "ece18be2-c8b4-4c2f-bf17-0734ba4a3ca5", "IdentityUser", null, false, true, null, null, "admin", "AQAAAAEAACcQAAAAEI7Z//8TgmQc4afIApTejzl6ZkFiriMqoxOFMjEotOVekaqyXrMkXatL3Lpmswx0vw==", null, false, "JBOPAV6NDGLHW27AVXZY63NQK7EMP5FK", false, "admin" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Computers_AdministratorId",
                table: "Computers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Computers_SerialNumber",
                table: "Computers",
                column: "SerialNumber",
                unique: true);
        }
